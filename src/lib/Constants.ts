...
export const Projects = [
    ...
    { name: 'Custos - Threat Intelligence', url: '', image: '/assets/custos.png', description: 'A platform for explainable threat detection, providing actionable insights to enhance enterprise security.', github: 'https://github.com/labib-c/Custos-Public', label: "personal"},
    { name: 'CourseHub', url: 'https://coursehub.ca', image: '/assets/coursehub.png', description: 'A user-driven platform for feedback and reviews on University of Toronto courses, helping students make informed decisions.' , github: 'https://github.com/labib-c/coursehub', label: "personal"},
];
